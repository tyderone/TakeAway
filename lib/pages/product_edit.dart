...
class _ProductEditPageState extends State<ProductEditPage> {
  ...
  Widget _buildQuantityTextField(Product product) {

    if (product == null && _quantityTextController.text.trim() == '') {
      _quantityTextController.text = '';

    } else if (product != null &&
        _quantityTextController.text.trim() == '') {
      _quantityTextController.text = product.quantity.toString();
    }
    return EnsureVisibleWhenFocused(
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              _buildQuantityTextField(product),
              SizedBox(
                height: 10.0,
              ),
    ...
    if (selectedProductIndex == -1) {
      addProduct(
         ...
         double.parse(_priceTextController.text.replaceFirst(RegExp(r','), '.')),
          double.parse(_quantityTextController.text.replaceFirst(RegExp(r','), '.')),
        ...
        if (success) {
          ...
          showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  title: Text('quantity must more than 2 Items'),
